...
export default function TermsOfService() {
  ...
  return (
    ...
    >
      ...
      <p>
        <strong>App Name:</strong> {terms.appName}
      </p>
      <p>
        <strong>Developer:</strong> {terms.company}
      </p>
      ...
      <ul>
        ...
        <li>
          Manage store information including addresses, contact details, and
          business hours
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          You must have the necessary permissions to install apps on your
          Shopify store
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          We do not share your data with third parties except as required for
          service provision
        </li>
      </ul>
      ...
      <p>
        By using the App, you agree to comply with Google's Terms of Service for
        Maps services.
      </p>

      <h3>6.2 Fallback Services</h3>
      <p>
        The App includes fallback services (OpenStreetMap) to ensure reliability
        when Google Maps services are unavailable.
      </p>
      ...
      <p>
        <strong>
          IN NO EVENT SHALL {terms.company.toUpperCase()} BE LIABLE FOR ANY
      ...
      <p>
        You agree to indemnify and hold harmless {terms.company} from any
      ...
      <p>
        ...
        the jurisdiction where {terms.company} is incorporated, without regard
      ...
      <p>
        ...
        {terms.company} regarding the App and supersede all prior agreements and
        understandings.
      </p>
      ...
      <p>
        ...
        <br />
        Email: <a href={`mailto:${terms.contact}`}>{terms.contact}</a>
        <br />
        Website: <a href={terms.website}>{terms.website}</a>
      </p>
      ...
      <p>
        <em>Last Updated: {terms.effectiveDate}</em>
        <br />
        <em>Version: {terms.version}</em>
      </p>
    </div>
  );
}
