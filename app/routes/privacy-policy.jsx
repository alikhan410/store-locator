...
export default function PrivacyPolicy() {
  ...
  return (
    ...
    >
      ...
      <p>
        <strong>App Name:</strong> {privacyPolicy.appName}
      </p>
      <p>
        <strong>Company:</strong> {privacyPolicy.company}
      </p>

      <h2>1. Who We Are</h2>
      <p>
        {privacyPolicy.company} is a Colorado-based business that develops the
        Store Locator app for Shopify merchants.
      </p>

      <h2>2. Information We Collect</h2>
      <p>
        We collect the following types of information when you use our Store
        Locator app:
      </p>
      <ul>
        <li>
          <strong>Store Information:</strong> Store names, addresses, phone
          numbers, websites, and business hours
        </li>
        <li>
          <strong>Shopify Data:</strong> Your Shopify store domain and basic
          store information
        </li>
        <li>
          <strong>Usage Data:</strong> How you interact with our app (features
          used, settings configured)
        </li>
        <li>
          <strong>Technical Data:</strong> IP address, browser type, and app
          performance data
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Isolated by Shopify store (your data is separate from other merchants)
        </li>
      ...
      <ul>
        <li>
          <strong>Google Maps API:</strong> For geocoding addresses and
          displaying maps
        </li>
        <li>
          <strong>Shopify APIs:</strong> For app integration and authentication
        </li>
        <li>
          <strong>Hosting Services:</strong> For app infrastructure and data
          storage
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Email:</strong>{" "}
          <a href="mailto:mkbernier@gmail.com">mkbernier@gmail.com</a>
        </li>
        <li>
          <strong>Subject:</strong> Privacy Policy Question - Store Locator
        </li>
      </ul>
      ...
      <p>
        ...
        posted here and in the app. Your continued use of the app indicates
      ...
      <p>
        <em>Last updated: {privacyPolicy.effectiveDate}</em>
      </p>
    </div>
  );
}
